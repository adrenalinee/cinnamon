...
public class EmailRestController {
	...
	EmailServer findEmailServer(@PathVariable Long emailServerId) {
		logger.info("start");
		return emailServerService.getEmailServer(emailServerId);
	}
	...
	@ResponseBody
	Map<String, String> emailServerSendTest(
			@PathVariable Long emailServerId,
			@ModelAttribute EmailServerVo emailServerVo) throws Exception {
		logger.info("start");
