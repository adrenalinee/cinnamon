...
public class SiteRestController {
	...
	List<MenuWithPosition> list (@PathVariable String siteId, @PathVariable Long menuGroupId) {
		...
		List<MenuWithPosition> separatedMenus = Lists.newArrayList();
		List<Menu> sidebarMenus = Lists.newArrayList();
		List<Menu> headerLeftMenus = Lists.newArrayList();
		List<Menu> headerRightMenus = Lists.newArrayList();
...
//	}
	...
	void putDefaultMenuGroup(@PathVariable String siteId, @RequestBody @Valid MenuGroupInfo menuGroupInfo) {
		logger.info("start");
	...
	Boolean getDeleteable(@PathVariable String siteId) {
		logger.info("start");
		
		return siteService.isDeleteable(siteId);
	}
	...
	void deleteSite(@PathVariable String siteId) {
		logger.info("start");
