 ...
 * function(rejection) { console.log('responseError'); console.log(rejection);
 * 
 * $mdDialog.show( $mdDialog.alert() .title('오류')
 * .textContent(rejection.data.message) .ok('확인') );
 * 
 * 
 ...
 */.config(
		function($locationProvider, $httpProvider, $mdThemingProvider) {
			...
			// var token =
			// angular.element(document).find("meta[name='_csrf']").attr("content");
			// var header =
			// angular.element(document).find("meta[name='_csrf_header']").attr("content");
