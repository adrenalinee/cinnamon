...
.controller('configuration.users.create', function($scope, $http, $interval, $state, $mdToast, $mdDialog, $mdMedia, message) {
	...
	$scope.create = function(form, event) {
		...
		$http.head('/rest/configuration/users/' + $scope.domain.userId)
			.success(function(data, status) {
				message.alert('이미 사용중인 아이디 입니다. 다른 아이디를 입력하시기 바랍니다.');
